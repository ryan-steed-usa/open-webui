...
## [0.6.42-rsu2] - 2025-12-21

### Added

- View generation statistics in a more user-friendly format. Adds a new setting "Show Friendly Generation Stats" in the chat interface settings panel. The feature is disabled by default and can be toggled in the chat settings interface. When enabled, users will see formatted time values (e.g., "2.5s" instead of "2500") in generation statistics.
